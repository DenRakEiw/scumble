...
// prompt, model (gpt-image-2.5-flare / -sunburst, gpt-image-2), size,
// quality (2.5 adds xhigh and max), input_fidelity (gpt-image-2 only). The answer carries b64_json.
"use strict";
...
module.exports = {
    ...
    async edit(req, ctx) {
        ...
        if (p.input_fidelity && /gpt-image-2$/.test(model)) fd.append("input_fidelity", p.input_fidelity);
